    ...
    private func setupSections() {
        sections = [
            ...
            .information(viewModels: [
                .init(type: .gender, value: character.status.rawValue),
            ...
            .episodes(viewModels: character.episode.compactMap({ RMCharacterEpisodeCollectionViewCellViewModel(episodeDataURL: URL(string: $0)) }))
        ]
    }
